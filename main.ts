...
let messageNew: string = `${famous_person} once said, “A person who never made a mistake never tried anything new.”`;
...
let message :string = "You're invited to a day filled with laughter and joy as we celebrate my birthday!"
...
let transportation: string[]= ['civic' , 'bike' , 'parado'];
...
let moreguest_List: string[] = ["Rozina", "Hania" ,"Ayan"];
...
let guest_table_List: string[] = ["Rozina", "Hania" ,"Ayan"];

let no_present: string= "Hania";
let neW_guest: string= "Anum";
...
// 01
let places: string[] = ["Switzerland" , "Japan" , "Itli" , "Iceland" , "Saudia Arabia"];
...
let dinner_guest_List: string[] = ["Rozina", "Hania" ,"Ayan"];
...
let languages: string[] = ["Urdu" , "chinese" , "Arabic" , "English" , "Hindi" , "French"];
...
let Flowers: string[] = ["Rose" , "Lily" , "Sun_flower" , "Lotus"];
...
let favorite_fruits: string[] = ["Strawberry" , "Banana" , "Oranges"];
...
let userNames: string[] = ["Admin" , "Noman" , "Haris" , "Eshal" , "Affan"];
...
let current_users: string[] = ["Sana" , "Madiha" , "Iqra" , "Nadeem" , "Hamza"];
let new_users: string[] = ["Anaya" , "Haseeb" , "Shayan" , "Hunain" , "Manahil"];
...
let favorite_pizza: string[] = ["chicken fajita" , "chicken tikka" , "pepperoni"];
...
let animals_name: string[] = ["dog", "cat", "rabbit"];
...
let magicians: string[] = ["Shams", "Shehzad", "Ibad"];
...
let other_magicians: string[] = ["Ebad", "Bungash", "Affan"];
...
const magicians_Name: string[] = ["Ebad", "Bungash", "Affan"];
...
// 45. Cars: Write a function that stores information about a car in a Object. The function should always receive a manufacturer and a 
...
function creat_car(manufacturer: string, model: string, option1: Record<string , any>): car{
    return{
        manufacturer,
        model,
        ...option1
 ...
 const mycar : car = creat_car("tyota" , "civic" , {color: "black" , year: 2023});
